...
function AddNewCoursePage() {
    ...
    function validateFormData() {
        console.log("Landing:", courseLandingFormData);
        console.log("Curriculum:", courseCurriculumFormData);

        // Check landing
        for (const key in courseLandingFormData) {
            if (isEmpty(courseLandingFormData[key])) {
                console.log("Empty landing field:", key);
                return false;
            }
        }
        ...
        // Check free preview
        const hasFreePreview = courseCurriculumFormData.some(item => item.freePreview === true);
        console.log("Has preview?", hasFreePreview);
    ...
    async function handelCreateCourse() {
        ...
        console.log(courseFinalFormData, "FinalFormData");
